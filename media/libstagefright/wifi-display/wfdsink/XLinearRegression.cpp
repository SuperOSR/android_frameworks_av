...
//#define LOG_NDEBUG 0
#define LOG_TAG "XLinearRegression"
#include <utils/Log.h>

#include "XLinearRegression.h"
...
XLinearRegression::XLinearRegression(size_t historySize)
...
XLinearRegression::~XLinearRegression() {
    delete[] mHistory;
    mHistory = NULL;
}

void XLinearRegression::addPoint(float x, float y) {
...
bool XLinearRegression::approxLine(float *n1, float *n2, float *b) const {
