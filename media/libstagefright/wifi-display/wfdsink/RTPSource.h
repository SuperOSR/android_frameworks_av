...
#define WIFI_DISPLAY_SINK_DEFAULT 0
...
// the RTCP channel.
struct RTPSource : public AHandler {
    RTPSource(const sp<ANetworkSession> &netSession);
    ...
    sp<RTPJitterBuffer> getRTPJitterBuffer();
...
private:
    ...
    XLinearRegression mRegression;
    int64_t mMaxDelayMs;

    sp<RTPJitterBuffer> mRTPJitterBuffer;
